## 1. Implementation
- [ ] 1.1 Create `packages/durable-outbox-sql-store` using `uv_build`.
- [ ] 1.2 Move SQL store implementation, schema constants, config, client protocol, and in-memory SQL client into `durable_outbox_sql_store`.
